...
const Hero = () => {
  ...
  return (
    <>
      <section className="max-cainer padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row justify-center" style={{ backgroundColor: '#282828' }}>
